...
////            multiplicandFract = new Fraction()
     ...
     * &minus;2 if desired. Be sure to test the latter give the desired results.
     * @return A QuadraticInteger object of the appropriate subclass. Two
     * examples: 8 + 9&radic;&minus;7, 8 + 9&radic;7.
     * @throws UnsupportedNumberDomainException If the ring parameter is not of
     * class ImaginaryQuadraticRing nor RealQuadraticRing.
     */
    ...
    public static QuadraticInteger applyTheta(int a, int b, QuadraticRing R) {
        return apply(a, b, R);
    }
